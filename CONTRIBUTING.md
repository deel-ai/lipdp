...
- run pylint on the anonymized main files, also with python 3.6, python 3.7 and python 3.8
...
your pull request should be accepted quickly (see [Governance policy](https://github.com/anonymized-ai/lipdp/blob/master/GOVERNANCE.md)).
